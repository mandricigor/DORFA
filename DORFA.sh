...
if [ "$haveInternal" -eq 1 ]; then
    ...
    wait
    cat $overlapDir/3prime_right_internal_left $overlapDir/internal_right_internal_left $overlapDir/internal_right_5prime_left $overlapDir/3prime_right_5prime_left > $overlapDir/all_overlaps
else
